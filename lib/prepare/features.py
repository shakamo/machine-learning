                                                                                       ...
                                                                                       np.where(y3 < 0.10, 0.05,
                                                                                                np.where(y3 < 0.2, 0.1,
                                                                                                         np.where(
                                                                                                             ...
                                                                                                             0.2,
                                                                                                             np.nan))))))
    df['Y1_11_M5_range'] = np.where(y5 < 0.015, 0, np.where(y5 < 0.03, 0.015, np.where(y5 < 0.05, 0.03,
                                                                                       np.where(y5 < 0.10, 0.05,
                                                                                                np.where(y5 < 0.2, 0.1,
                                                                                                         np.where(
                                                                                                             y5 < 0.3,
                                                                                                             0.2,
                                                                                                             np.nan))))))
    df['Y1_11_M15_range'] = np.where(y15 < 0.015, 0, np.where(y15 < 0.03, 0.015, np.where(y15 < 0.05, 0.03,
                                                                                          np.where(y15 < 0.10, 0.05,
                                                                                                   np.where(y15 < 0.2,
                                                                                                            0.1,
                                                                                                            np.where(
                                                                                                                y15 < 0.3,
                                                                                                                0.2,
                                                                                                                np.nan))))))
    df['Y1_11_M30_range'] = np.where(y30 < 0.015, 0, np.where(y30 < 0.03, 0.015, np.where(y30 < 0.05, 0.03,
                                                                                          np.where(y30 < 0.10, 0.05,
                                                                                                   np.where(y30 < 0.2,
                                                                                                            0.1,
                                                                                                            np.where(
                                                                                                                y30 < 0.3,
                                                                                                                0.2,
                                                                                                                np.nan))))))
    df['Y1_11_M60_range'] = np.where(y60 < 0.015, 0, np.where(y60 < 0.03, 0.015, np.where(y60 < 0.05, 0.03,
                                                                                          np.where(y60 < 0.10, 0.05,
                                                                                                   np.where(y60 < 0.2,
                                                                                                            0.1,
                                                                                                            np.where(
                                                                                                                y60 < 0.3,
                                                                                                                0.2,
                                                                                                                np.nan))))))
    df['Y1_11_M240_range'] = np.where(y240 < 0.015, 0, np.where(y240 < 0.03, 0.015, np.where(y240 < 0.05, 0.03,
                                                                                             np.where(y240 < 0.10, 0.05,
                                                                                                      np.where(
                                                                                                          y240 < 0.2,
                                                                                                          0.1, np.where(
                                                                                                              y240 < 0.3,
